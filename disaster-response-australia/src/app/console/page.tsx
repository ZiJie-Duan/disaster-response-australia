...
export default function RescuerConsolePage({
  ...
  // TODO: After backend integration, replace this with real API request results (refer to ConsoleData structure below).
  // For example:
  //   const [consoleData, setConsoleData] = useState(EMPTY_CONSOLE_DATA);
  //   useEffect(() => {
  //     fetch('/api/console').then((res) => res.json()).then(setConsoleData);
  //   }, []);
  const consoleData = initialData; // Temporarily using placeholder data for frontend development.
